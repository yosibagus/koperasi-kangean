                ...
                .on(
                    ...
                    function () {
                        var b = a(this),
                            c = b.data(),
                            d =
                                b.hasClass(z.navDisabled) ||
                                b.hasClass(z.disabled),
                            e = j();
        ...
        function s() {
            ...
            !0 === y.hiddenName
                ...
                A.on("change." + x.id, function () {
                    C._hidden.value = h.value
                        ? C.get("select", y.formatSubmit)
                        : "";
                });
        }
        function t() {
                ...
                render: function (b) {
                    return (
                        b
                            ? ((C.$holder = a(o())),
                              r(),
                              C.$root.html(C.$holder))
                            : C.$root
                                  .find("." + z.box)
                                  .html(C.component.nodes(x.open)),
                        C.trigger("render")
                    );
                },
                stop: function () {
                    return x.start
                        ? (C.close(),
                          C._hidden &&
                              C._hidden.parentNode.removeChild(C._hidden),
                          C.$root.remove(),
