...
class TabunganController extends Controller
{
    ...
    public function rekap_tabungan()
    {
        $data['tabungan'] = DB::table('tabungans as t')
            ->join('rekenings as r', 'r.id_rekening', '=', 't.rekening_id')
            ->join('kategoris as k', 'k.id_kategori', '=', 'r.kategori_id')
            ->select(
                'r.no_rekening',
                'r.nama_rekening',
                'k.nama_kategori',
        ...
        $data['sum'] = $data['tabungan']->sum('total_saldo');


        return view('teller.tabungan.rekap_tabungan', $data);
    }
}
