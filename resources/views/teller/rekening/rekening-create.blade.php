                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="nama_rekening" class="form-label required">Nama
                                                    Pemilik</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="5" name="kode_pos" id="kode_pos"
                                                    inputmode="numeric"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="ktp" id="ktp" min="16"
                                            max="16" class="form-control @error('ktp') is-invalid @enderror"
