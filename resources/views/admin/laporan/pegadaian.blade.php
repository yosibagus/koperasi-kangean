<x-admin>
  <x-slot name="title">Laporan Pegadaian</x-slot>
  <x-slot name="styles">
  ...
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('pegadaian.laporan') }}" method="GET" class="mb-3">
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="jenis" id="jenis" class="form-control">
                  ...
                  <option value="gadai" {{ request('jenis') == 'masuk' ? 'selected' : '' }}>Gadai
                  </option>
