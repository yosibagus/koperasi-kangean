<x-admin>
  ...
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('pinjaman.laporan') }}" method="GET" class=" mb-3">
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select name="jenis" id="jenis" class="form-control">
                  ...
                  <option value="pinjam" {{ request('jenis') == 'masuk' ? 'selected' : '' }}>Pinjam
                  </option>
                  <option value="lunas" {{ request('jenis') == 'keluar' ? 'selected' : '' }}>Lunas
                  </option>
                </select>
              </div>
            </div>
          ...
          <table id="tabelSaya" class="table table-hover table-bordered">
            <thead>
              <tr class="table-primary">
                ...
                <th class="table-primary">Jenis Pinjaman</th>
                <th class="table-primary">Jumlah Pinjaman</th>
                <th class="table-primary">Tanggal Pinjaman</th>
            ...
            <tbody>
              @forelse ($pinjaman as $item)
                <tr>
                  ...
                  <td>{{ $item->rekening->alamat }}</td>
                  <td>{{ $item->rekening->telepon }}</td>
